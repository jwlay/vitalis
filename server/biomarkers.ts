...
export const BIOMARKER_DB: BiomarkerInfo[] = [
  ...
  },
  {
    ...
    whyItMatters: "High LDL is the #1 modifiable risk factor for heart attacks. LDL 100–129 mg/dL is classified Near Optimal — adequate for healthy individuals but higher than ideal for those with cardiovascular risk factors. Lowering LDL by just 1 mmol/L (39 mg/dL) reduces heart attack risk by ~22%.",
    bodySystem: "Heart & Circulation",
  ...
  },
  {
    ...
    whyItMatters: "Low HDL is a strong risk factor for heart disease, particularly when combined with high LDL. For most people, raising HDL through regular aerobic exercise is beneficial. Note: very high HDL (>80 mg/dL) is not necessarily more protective and may reflect other conditions — context matters.",
    bodySystem: "Heart & Circulation",
  ...
  },
  {
    ...
    plainDescription: "ApoB represents the total count of atherogenic lipoprotein particles in your blood (LDL, VLDL, IDL). Each of these particles carries exactly one ApoB molecule, so ApoB is the most direct measure of particle burden — more informative than cholesterol content alone.",
